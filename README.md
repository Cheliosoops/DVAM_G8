...
### 图2: 蛋白质关键节点棒棒糖图
- 展示度中心性最高的前 20 个关键枢纽蛋白
- 橙色高亮 Top 3 核心蛋白（Trp53、Prkaca、Prkacb），揭示其断崖式领先优势
- 识别处于生物学通路核心位置、控制网络信息流动的关键节点   
...
### 图6: GO 阈值敏感性分析图
- 双轴折线图展示节点数与连边数随置信度阈值提高的衰减趋势
- 确定 700 阈值为剔除噪声边并保留核心节点的理想平衡点
- 通过不同指标的衰减速率验证 PPI 网络的鲁棒性与无尺度特征
